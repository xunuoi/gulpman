...
var spriter = function(options) {
	...
	var stream = through.obj(function(chunk, enc, cb) {
		...
		if (chunk.isStream()) {
			...
			// console.log('F: '+chunk.path)
			// var fileDir = path.dirname(chunk.relative)

			// console.log(settings['dist_root'])
			...
			chunk.base = path.join(settings['cwd'])
			// console.log(fileName)

			var relDistPath = path.join('gm_sprite_img', fileName+'_sprite_sheet.png')
